...
public class myListenerTest extends KnightCodeBaseListener{
	...
	public myListenerTest(String programName, boolean debug){
	...
	public void enterProgram(KnightCodeParser.FileContext ctx){

		System.out.println("Enter program rule for first time");
		setupClass();
	}

	public void exitProgram(KnightCodeParser.FileContext ctx){
